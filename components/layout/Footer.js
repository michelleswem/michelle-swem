    ...
    <footer className={classes.footer}>
      <div className='row'>
        <div className={classes.footer__logobox}>
          <Link href='/'>
            <a className={classes.footer__log}>
              <Image
        ...
        <div className={classes.footer__navigation}>
          <ul className={classes.footer__list}>
            <li className={classes.footer__item}>
              <Link href='/Writing'>
                <a className={classes.footer__link}>Writing</a>
              </Link>
            </li>
            <li className={classes.footer__item}>
              <Link href='/Projects'>
                <a className={classes.footer__link}>Projects</a>
              </Link>
            </li>
            <li className={classes.footer__item}>
              <Link href='/Blog'>
                <a className={classes.footer__link}>Blog</a>
              </Link>
            </li>
            <li className={classes.footer__item}>
              <Link href='/Shop'>
                <a className={classes.footer__link}>Shop</a>
              </Link>
            </li>
          </ul>
        </div>
        ...
        <p className={classes.footer__copyright}>
          Built By MICHELLE SWEM Copyright &copy; {year}
        </p>
        <div className={classes.footer__socials}>
          <Link href='/twiter'>
            <a className={classes.footer__icon}>
              <svg
                version='1.1'
